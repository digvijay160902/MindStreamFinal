...
const makeContact = async (req, res) => {
    try {
        ...
        res.status(200).json({
            success: true,
            message: "Conatact made Successfully",
            data: contactData,
        })
...
module.exports = { signUp ,login,getUser,makeContact};